...
class _CallState extends State<Call> {
 ...
 color: Color(0xff32CD32),
                ...
                const Text(
                  'Edo House Complex, Suite 105, Bishop Oluwole Street, Victoria Island, Lagos, Nigeria',
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.white,
                    fontWeight: FontWeight.w500,
 ...
 color: Color(0xff32CD32),
                ...
                const Text(
                  'Emekpa Junction, Ughelli-Patani Road, Ughelli, Delta State, Nigeria',
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.white,
                    fontWeight: FontWeight.w500,
